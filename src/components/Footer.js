  ...
  return (
    <div className='footer'>
      <div className='container'>
        <div className='footer__top pl__pr8'>
            <p>Yeddies</p>
        </div>

        <div className='footer__bottom pl__pr8'>
            ...
            <div className='footer__contacts pl__pr8'>
                <p>Connect with <span>#yeddies</span></p>
                <ul>
      ...
      <div className='footer__bottom__main'>
        <div className='container'>
            <div className='footer__rights pl__pr8'>
                <ul>
                    <li>Terms of use</li>
