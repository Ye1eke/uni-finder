      ...
      >
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="We help students to find postgraduate programs that align with their career goals and academic achievements and to enhance their university search experience."
            {...getOverrideProps(
              overrides,
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="Our unique algorithm matches students with postgraduate programs based on their preferences and qualifications, ensuring personalized recommendations."
            {...getOverrideProps(
              overrides,
        ...
        >
          <Text
            ...
            {...getOverrideProps(overrides, "What will you get? \uD83D\uDC23")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="14px"
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="You will gain access to a wide range of postgraduate programs, also receive reliable information to make informed decisions about your future education."
            {...getOverrideProps(
              overrides,
